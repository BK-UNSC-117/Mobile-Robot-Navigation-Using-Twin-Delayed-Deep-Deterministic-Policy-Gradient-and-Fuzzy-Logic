...
class fuz_ctrl:
    ...
    def get_action(self,degree,distance):
        self.degree=degree
        self.distance=distance
        self.obs_ctrl.input["degree"]=self.degree
        self.obs_ctrl.input["dist"]=self.distance
        
        self.obs_ctrl.compute()

        return self.obs_ctrl.output["linear"],self.obs_ctrl.output["angular"]
